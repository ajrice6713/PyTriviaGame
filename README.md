...
# PyTriviaGame
A basic trivia messaging game that leverages Bandwidth's messaging API along with the Python Trivia API, an API that pulls trivia questions from [OpenTDB.](https://opentdb.com/)
